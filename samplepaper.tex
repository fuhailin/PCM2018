...
\keywords{Recommendation systems \and Social media data mining \and bidirectional recurrent neural network \and convolutional neural network \and deep learning.}
\end{abstract}
% 
%
%
...
\bibitem{23} Tang, Jiaxi, and Ke Wang. "Personalized Top-N Sequential Recommendation via Convolutional Sequence Embedding." [C]//Proceedings of the Eleventh ACM International Conference on Web Search and Data Mining. WSDM 2018: 565-573. (2018).
\end{thebibliography}
\end{document}
